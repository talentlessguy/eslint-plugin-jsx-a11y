...
const interactiveElementAXObjectSchemas = [...elementAXObjects].reduce((accumulator, [elementSchema, AXObjectSet]) => {
 ...
 */
const isInteractiveElement = (tagName: string, attributes: Array<Node>): boolean => {
