...
import { elementType, eventHandlersByType, getPropValue, getProp, hasProp, propName } from 'jsx-ast-utils'
      ...
      JSXOpeningElement: (node: JSXOpeningElement) => {
        ...
        if (Object.prototype.hasOwnProperty.call(config, type)) {
          attributes = attributes.filter(
            attr => attr.type !== 'JSXSpreadAttribute' && !config[type].includes(propName(attr))
          )
        }
